...
var rootCmd = &cobra.Command{
	Use:   "my-calc",
	Short: "It's a basic Calculator Application",
	Long: `
	 It's a for doing simple math such as addition
	 subtraction division multiplication only
	 with commands add sub div mul etc.`,
	// Uncomment the following line if your bare application
	// has an action associated with it:
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("My-calculator Application")
	},
}
